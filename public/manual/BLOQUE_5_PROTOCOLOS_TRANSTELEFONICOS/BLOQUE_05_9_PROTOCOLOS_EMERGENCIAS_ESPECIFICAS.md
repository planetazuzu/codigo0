...
- Se relaciona con [triage START (1.4)](/manual/parte-i-fundamentos/bloque-1-procedimientos-basicos/1.2.4) para priorización.
...
## 9. PROTOCOLO 6: CRISIS CONVULSIVAS

### 9.1 Objetivo operativo

Garantizar seguridad del paciente y del equipo, controlar la crisis convulsiva y decidir traslado según criterios de gravedad.

### 9.2 Evaluación inicial (ABCDE + neurológico)

**ABCDE prioritario:**
- **A:** Vía aérea permeable tras la crisis, retirar cuerpos extraños visibles.
- **B:** Ventilación efectiva, valorar cianosis durante la crisis.
- **C:** Perfusión, TA y FC.
- **D:** Nivel de conciencia postcrítico, déficit focal, convulsión activa.
- **E:** Buscar traumatismos asociados, mordedura lingual, control térmico.

**Evaluación específica:**
- Duración de la convulsión.
- Número de crisis y recuperación entre ellas.
- Primera convulsión vs epiléptico conocido.
- Posible causa: fiebre, hipoglucemia, tóxicos, TCE.
- Cumplimiento del tratamiento habitual si epiléptico.

### 9.3 Criterios de gravedad

**CRITERIOS DE GRAVEDAD:**
- ❌ Convulsión activa > 5 minutos.
- ❌ Crisis repetidas sin recuperación completa.
- ❌ Alteración persistente del nivel de conciencia.
- ❌ Déficit neurológico focal.
- ❌ Convulsión secundaria a TCE, intoxicación o hipoglucemia.
- ❌ Embarazo, edad pediátrica o anciano frágil.

### 9.4 Intervenciones TES

**Durante la crisis:**
- Proteger al paciente **sin sujetar**.
- Retirar objetos peligrosos del entorno.

**Tras la crisis:**
- Posición lateral de seguridad si disminuye conciencia.
- Oxigenoterapia si SpO2 < 94%.
- Control de constantes seriadas.
- Glucemia capilar si procede.
- Evitar estímulos innecesarios.
- Registrar tiempos y evolución.

**Tratamiento anticonvulsivante (según protocolo):**
- Considerar benzodiacepina si crisis prolongada o repetida.

### 9.5 Traslado urgente

**Traslado urgente si:**
- Primera convulsión.
- Convulsión prolongada o repetida.
- Recuperación incompleta.
- Sospecha de causa secundaria grave.
- Indicación del centro coordinador.

### 9.6 Comunicación hospitalaria
...
## 10. PROTOCOLO 7: SHOCK ANAFILÁCTICO

### 10.1 Objetivo operativo

Reconocer anafilaxia precozmente, revertir compromiso vital y asegurar traslado urgente.

### 10.2 Evaluación inicial (ABCDE + signos de anafilaxia)

**ABCDE prioritario:**
- **A:** Edema de lengua/laringe, estridor, riesgo de obstrucción.
- **B:** Disnea, sibilancias, broncoespasmo, cianosis.
- **C:** Hipotensión, taquicardia, piel fría.
- **D:** Nivel de conciencia alterado.
- **E:** Urticaria, angioedema, enrojecimiento, prurito.

**Criterios clínicos de anafilaxia:**
- Inicio rápido tras exposición a alérgeno.
- Compromiso respiratorio y/o cardiovascular.
- Afectación cutánea/mucosa habitual (no siempre presente).

### 10.3 Criterios de gravedad

**CRITERIOS DE GRAVEDAD:**
- ❌ Compromiso respiratorio (estridor, broncoespasmo severo).
- ❌ Hipotensión o signos de shock.
- ❌ Alteración del nivel de conciencia.
- ❌ Progresión rápida de síntomas.

### 10.4 Intervenciones TES

**Medidas iniciales:**
- Retirar alérgeno si es posible (p. ej., detener infusión, retirar aguijón).
- Posición supina con elevación de piernas si hipotensión.
- Oxigenoterapia alto flujo.
- Monitorización continua.

**Adrenalina IM (fármaco de elección):**
- **Adultos:** 0,3–0,5 mg IM (1 mg/ml = 1:1000).
- **Niños:** 0,01 mg/kg IM (máx. 0,3 mg).
- **Repetir cada 5–10 min** si no respuesta.

**Soporte adicional (según protocolo y disponibilidad):**
- Sueroterapia IV rápida si hipotensión.
- Antihistamínicos y corticoides como coadyuvantes.
- Broncodilatadores si broncoespasmo.

### 10.5 Traslado urgente

**Traslado urgente SIEMPRE:**
- Anafilaxia confirmada o altamente sospechada.
- Respuesta parcial o transitoria a adrenalina.
- Necesidad de más de una dosis.

### 10.6 Comunicación hospitalaria

**Informar al recibir:**
- Alérgeno sospechado y tiempo de exposición.
- Síntomas respiratorios/cardiovasculares presentes.
- Dosis y número de adrenalinas administradas.
- Respuesta clínica.
- Constantes vitales.

---

## 11. PROTOCOLO 8: INTOXICACIÓN AGUDA

### 11.1 Objetivo operativo

Identificar intoxicación potencialmente grave, estabilizar funciones vitales y trasladar con información clave del tóxico.

### 11.2 Evaluación inicial (ABCDE + tóxicos)

**ABCDE prioritario:**
- **A:** Riesgo de broncoaspiración, vómitos, disminución del nivel de conciencia.
- **B:** Depresión respiratoria, hipoventilación, broncoespasmo.
- **C:** Hipotensión, arritmias, piel fría/sudorosa.
- **D:** Alteración neurológica, convulsiones, pupilas.
- **E:** Exposición cutánea, olores, quemaduras químicas.

**Evaluación específica:**
- Tipo de tóxico sospechado (medicación, alcohol, drogas, químicos).
- Cantidad y hora de ingesta/exposición.
- Vía de exposición: oral, inhalatoria, cutánea.
- Envases o etiquetas disponibles.

### 11.3 Criterios de gravedad

**CRITERIOS DE GRAVEDAD:**
- ❌ Alteración importante del nivel de conciencia.
- ❌ Depresión respiratoria o hipoxia.
- ❌ Convulsiones.
- ❌ Arritmias o hipotensión.
- ❌ Intoxicación por múltiples sustancias.
- ❌ Exposición a sustancias cáusticas o corrosivas.

### 11.4 Intervenciones TES

**Medidas iniciales:**
- Retirar fuente de exposición si es seguro.
- Oxigenoterapia si precisa.
- Monitorización continua ECG, TA, SpO2.
- Glucemia capilar si alteración neurológica.

**Medidas específicas:**
- No inducir el vómito.
- Considerar carbón activado solo si protocolo lo permite.
- Si sospecha de intoxicación por opioides: considerar naloxona según protocolo.

### 11.5 Traslado urgente

**Traslado urgente si:**
- Cualquier criterio de gravedad.
- Ingesta desconocida o intencional.
- Síntomas progresivos.
- Paciente pediátrico o anciano.

### 11.6 Comunicación hospitalaria

**Informar al recibir:**
- Sustancia sospechada, cantidad, hora de exposición.
- Vía de exposición.
- Síntomas principales.
- Constantes vitales.
- Tratamientos administrados.
- Envases o etiquetas recogidas.

---

## 12. PROTOCOLO 9: PARTO INMINENTE

### 12.1 Objetivo operativo

Asistir un parto inminente de forma segura, prevenir complicaciones inmediatas y organizar traslado materno-neonatal.

### 12.2 Evaluación inicial (ABCDE + obstétrico)

**ABCDE prioritario:**
- **A/B:** Asegurar ventilación materna, oxigenoterapia si precisa.
- **C:** Control de sangrado, TA y FC.
- **D:** Nivel de conciencia materno.
- **E:** Exposición con privacidad y control térmico.

**Evaluación obstétrica:**
- Tiempo de gestación aproximado.
- Contracciones: frecuencia e intensidad.
- Sensación de pujo incontrolable.
- Bolsa rota y características del líquido.
- Si coronación visible o presentación de nalgas/cara.

### 12.3 Criterios de gravedad

**CRITERIOS DE GRAVEDAD:**
- ❌ Sangrado vaginal abundante.
- ❌ Presentación anómala (nalgas, transversa).
- ❌ Prolapso de cordón.
- ❌ Parto múltiple conocido.
- ❌ Meconio espeso o líquido maloliente.
- ❌ Madre con alteración hemodinámica.

### 12.4 Intervenciones TES

**Preparación:**
- Crear entorno limpio y cálido.
- Colocar campos y material estéril si disponible.
- Preparar pinzas para cordón.

**Asistencia al parto:**
- No frenar la salida de la cabeza, guiar suavemente.
- Comprobar circular de cordón y liberar si es posible.
- Secar y estimular al recién nacido.
- Pinzar y cortar cordón (si protocolo lo permite).

**Cuidados del recién nacido:**
- Valorar respiración y tono.
- Mantener calor (piel con piel, mantas).
- Aspiración solo si obstrucción evidente.

### 12.5 Traslado urgente

**Traslado urgente si:**
- Cualquier criterio de gravedad.
- Parto pretérmino.
- Recién nacido con mala adaptación.
- Complicaciones maternas postparto.

### 12.6 Comunicación hospitalaria

**Informar al recibir:**
- Edad gestacional estimada.
- Tiempo y características del parto.
- Complicaciones observadas.
- Estado materno y neonatal.
- Intervenciones realizadas.

---

## 13. PROTOCOLO 10: HIPOTERMIA / HIPERTERMIA

### 13.1 Objetivo operativo

Identificar alteraciones térmicas graves, iniciar medidas de control térmico y trasladar con monitorización continua.

### 13.2 Evaluación inicial (ABCDE + temperatura)

**ABCDE prioritario:**
- **A/B:** Riesgo de depresión respiratoria en hipotermia grave.
- **C:** Bradicardia/arrítmias en hipotermia, taquicardia en hipertermia.
- **D:** Alteración del nivel de conciencia.
- **E:** Exposición completa para buscar causas (ambiental, infecciosa, fármacos).

**Evaluación específica:**
- Temperatura central si posible.
- Tiempo de exposición al calor/frío.
- Síntomas asociados: escalofríos, rigidez, confusión, convulsiones.

### 13.3 Criterios de gravedad

**CRITERIOS DE GRAVEDAD:**
- ❌ Temperatura < 32°C o > 40°C.
- ❌ Alteración del nivel de conciencia.
- ❌ Arritmias o inestabilidad hemodinámica.
- ❌ Convulsiones.
- ❌ Sospecha de golpe de calor.

### 13.4 Intervenciones TES

**Hipotermia:**
- Retirar ropa húmeda y aislar del suelo.
- Abrigo progresivo (mantas, calor externo).
- Evitar movimientos bruscos en hipotermia grave.

**Hipertermia:**
- Enfriamiento externo gradual (paños húmedos, ventilación).
- Retirar exceso de ropa.
- Hidratación si consciente y sin riesgo de aspiración.
...
### 13.5 Traslado urgente

**Traslado urgente si:**
- Cualquier criterio de gravedad.
- Golpe de calor sospechado.
- Hipotermia moderada/grave.
- Comorbilidades importantes o paciente pediátrico/anciano.

### 13.6 Comunicación hospitalaria

**Informar al recibir:**
- Temperatura registrada y evolución.
- Tiempo de exposición y causa probable.
- Síntomas principales.
- Constantes vitales.
- Medidas aplicadas.
...
**NOTA:** Este capítulo incluye los protocolos 1-10.
