...
# 3.0 – Oxigenoterapia: Uso Operativo y Seguridad
...
Proporcionar oxigenoterapia de forma segura y efectiva según necesidad clínica, incluyendo:
- Selección y aplicación de dispositivos de oxigenoterapia
- Manejo seguro de equipamiento (botellas, montaje, verificación)
- Cálculo de duración y gestión del consumo
- Prevención de incidentes

Este capítulo integra **técnica operativa de aplicación** con **seguridad en equipamiento**, e integra con **evaluación primaria ABCDE (1.2) y monitorización (1.1)**.
...
- **Manejo seguro de botellas** y equipamiento
- **Montaje y verificación** del sistema
- **Cálculo de duración** de botellas
- **Gestión del consumo** durante servicio
...
- Manejo seguro de equipamiento

**Integración:**
- Se integra con [**1.2 – ABCDE Operativo**](/manual/parte-i-fundamentos/bloque-1-procedimientos-basicos/1.2.2) (paso B: Breathing)
- Se relaciona con [**1.1 – Constantes Vitales**](/manual/parte-i-fundamentos/bloque-1-procedimientos-basicos/1.2.1) (SpO₂ monitorización)
...
### 3.4 Seguridad primero: equipamiento y manipulación

**Principio:**
- El oxígeno acelera la combustión (NO es inflamable pero aumenta riesgo de incendio)
- Las botellas contienen gas a alta presión (riesgo de explosión/proyección)
- NUNCA usar grasas/aceites en conexiones de oxígeno

**Aplicación:**
- Fijar botellas correctamente siempre
- Verificar fugas sistemáticamente
- Calcular duración antes de usar
...
### C) Mascarilla con reservorio (mascarilla de no reinhalación)
...
## Selección Rápida de Dispositivo

### Algoritmo de selección operativo
...
## Montaje y Verificación Paso a Paso
...
### Paso 2: Aplicación del dispositivo
...
### Paso 4: Mantenimiento y reevaluación
...
## Cálculo de Duración de Botellas de O₂
...
## Gestión del Consumo Durante el Servicio
...
### Problema 1: SpO₂ no mejora con O₂
...
### Problema 2: Paciente no tolera dispositivo
...
### Problema 4: Dispositivo se obstruye o falla
...
## Integración con ABCDE y Otras Técnicas

### Con evaluación primaria (ABCDE - paso B)
...
- **Dejar reserva** (20-30 bar) y cambiar botella antes de agotarse
