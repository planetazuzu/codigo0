...
import type { Procedure, Priority } from '@/data/procedures';
...
const ProcedureCard = memo(({ procedure, defaultExpanded = false }: ProcedureCardProps) => {
  ...
  // Guard defensivo: no renderizar si procedure es inválido (después de hooks)
  if (!procedure || typeof procedure !== 'object' || !procedure.id) {
    return null;
  }
