...
const EmergencyButton = ({
  ...
  return (
    <Link
      to={to}
      className={cn(
        'btn-emergency flex flex-col items-center justify-center gap-1 p-4 active:scale-[0.98] active:opacity-90 transition-transform',
    ...
    >
      ...
      {subtitle && (
        <span className="text-xs opacity-90 text-center">{subtitle}</span>
      )}
    </Link>
  );
};
